...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_TIMERESPONSE']._serialized_end=91
  _globals['_CLOCKSYNC']._serialized_start=93
  _globals['_CLOCKSYNC']._serialized_end=187
